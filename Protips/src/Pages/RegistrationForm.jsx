  ...
  return (
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="submit" value={"Register"} style={{backgroundColor: "red" , color:"white" ,  border:"none" , fontSize:"18px" , borderRadius:"2px" , padding:"10px", height:"auto" , cursor:"pointer"}}/>  
